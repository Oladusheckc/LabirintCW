## Курсовая работа по построению Лабиринтов и поиска пути в них, с использованием иерархии классов.
  ...
  В рамкох учебы в вузе(2023) была сделанна курсовая работа по теме "РАЗРАБОТКА ИЕРАРХИИ КЛАССОВ ДЛЯ ПОСТРОЕНИЯ ЛАБИРИНТОВ В C#" где были реализованны алгоритмы построения лабиринтов нескольких типов, а также алгоритм поиска пути в ширину.
